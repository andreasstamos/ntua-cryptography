...
genLargeInt :: Gen Integer
genLargeInt = choose (10^6, 10^9)

prop_isPrime :: Integer -> Bool
prop_isPrime n = isPrime_oracle n == (isPrime n checks)
...
main = do
  ...
  putStrLn "Random checking 10^4 numbers in [10^6, 10^9] using QuickCheck."
  quickCheck $ withMaxSuccess 10000 $ forAll genLargeInt prop_isPrime
